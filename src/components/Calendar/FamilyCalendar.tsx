        ...
        <div className="glass p-6">
            ...
            <div className="flex items-center justify-between mb-8">
                <div>
                    ...
                    <p className="text-xs text-[var(--text)] opacity-40 uppercase tracking-widest mt-1">Podgląd wydarzeń</p>
                </div>
                <div className="flex gap-2">
                    <button onClick={prevMonth} className="p-2 glass rounded-xl hover:bg-white/10 transition-colors border-white/5">
                        <ChevronLeft className="w-5 h-5 text-[var(--text)]" />
                    </button>
                    <button onClick={nextMonth} className="p-2 glass rounded-xl hover:bg-white/10 transition-colors border-white/5">
